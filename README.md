...
Da poženemo program, ki število korakov za izračun integrala na 10 mest natančno ter njegove vrednosti v julia REPL poženemo "include("dn2/scripts/dn2.jl")"
